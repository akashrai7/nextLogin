          ...
          <div class="tab-content" id="myTabContent">
            ...
            >
              <iframe
                ...
                style="border: 0; width: 100%; display: block; height: 400px"
                allowfullscreen
                loading="lazy"
      ...
      <div class="card bg-white border-0 rounded-3 mb-4">
        <div class="card-body p-4">
          ...
          <ul class="nav nav-tabs mb-4" id="myTab22" role="tablist">
            <li class="nav-item" role="presentation">
              <button
                ...
                id="preview22-tab"
                data-bs-toggle="tab"
                data-bs-target="#preview22-tab-pane"
                type="button"
                role="tab"
                aria-controls="preview22-tab-pane"
                aria-selected="true"
              >
                Preview
              </button>
            ...
            <li class="nav-item" role="presentation">
              <button
                ...
                id="code22-tab"
                data-bs-toggle="tab"
                data-bs-target="#code22-tab-pane"
                type="button"
                role="tab"
                aria-controls="code22-tab-pane"
                aria-selected="false"
              >
                Code
              </button>
          ...
          <div class="tab-content" id="myTabContent22">
            <div
              class="tab-pane fade show active"
              id="preview22-tab-pane"
              role="tabpanel"
              aria-labelledby="preview22-tab"
              tabindex="0"
            >
              <iframe
            ...
            <div
              ...
              id="code22-tab-pane"
              role="tabpanel"
              aria-labelledby="code22-tab"
              tabindex="0"
            >
              <button
                class="btn btn-outline-primary bg-white btn-sm copy-btn position-absolute top-0 end-0"
                data-clipboard-target="#basicAlertsCode22"
              >
                Copy
              </button>
              <pre class="line-numbers pt-0 pb-0 ps-25 pe-25 mb-0">
      ...
      <div class="card bg-white border-0 rounded-3 mb-4">
        <div class="card-body p-4">
          ...
          <ul class="nav nav-tabs mb-4" id="myTab11" role="tablist">
            <li class="nav-item" role="presentation">
              <button
                ...
                id="preview11-tab"
                data-bs-toggle="tab"
                data-bs-target="#preview11-tab-pane"
                type="button"
                role="tab"
                aria-controls="preview11-tab-pane"
                aria-selected="true"
              >
                Preview
              </button>
            ...
            <li class="nav-item" role="presentation">
              <button
                ...
                id="code11-tab"
                data-bs-toggle="tab"
                data-bs-target="#code11-tab-pane"
                type="button"
                role="tab"
                aria-controls="code11-tab-pane"
                aria-selected="false"
              >
                Code
              </button>
          ...
          <div class="tab-content" id="myTabContent11">
            <div
              class="tab-pane fade show active"
              id="preview11-tab-pane"
              role="tabpanel"
              aria-labelledby="preview11-tab"
              tabindex="0"
            >
              <iframe
            ...
            <div
              ...
              id="code11-tab-pane"
              role="tabpanel"
              aria-labelledby="code11-tab"
              tabindex="0"
            >
              <button
                class="btn btn-outline-primary bg-white btn-sm copy-btn position-absolute top-0 end-0"
                data-clipboard-target="#basicAlertsCode11"
              >
                Copy
              </button>
              <pre class="line-numbers pt-0 pb-0 ps-25 pe-25 mb-0">
